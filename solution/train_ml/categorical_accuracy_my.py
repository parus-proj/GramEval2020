...
@Metric.register("categorical_accuracy_my")
class CategoricalAccuracyMy(Metric):
    """
...
#         print( "ITLOG: 3" )
#         print( "ITLOG: predictions.size() = {}".format(predictions.size()) )
#         print( "ITLOG: gold_labels.size() = {}".format(gold_labels.size()) )
#         print( "ITLOG: mask.size() = {}".format(mask.size()) )
#         print("\n------------------------------------------------- ITLOG-END ------------------------------------------\n")
