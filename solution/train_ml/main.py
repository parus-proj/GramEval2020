...
from train_ml.dataset_reader import UDDatasetReader
from train_ml.lemmatize_helper import LemmatizeHelper
from train_ml.model import DependencyParser, LstmWeightDropSeq2SeqEncoder, TaskConfig
from train_ml.morpho_vectorizer import MorphoVectorizer
...
#     print("\n\n------------------------------------------------- ITLOG-BEGIN ------------------------------------------\n")
#     logger.info('ITLOG: EXAMPLE BATCH:')
#     #iterator = BucketIterator(batch_size=2)
#     iterator = BasicIterator(batch_size=3)
#     iterator.index_with(vocab)
#     #_log_batch(next(iterator(train_data)))
#     batch000 = next(iterator(train_data))
#     #print(batch000)
#     print(batch000['pos_tags'])
#     print(batch000['grammar_values'])
